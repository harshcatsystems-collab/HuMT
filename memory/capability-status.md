...
# Last full audit: 2026-02-14 00:00 UTC (auto-cron)
...
## Last Verified: 2026-02-14 00:00 UTC
## Environment: VPS (Debian 12, GCP, 34.93.212.225)

| # | Capability | Status | How | Last Tested |
|---|-----------|--------|-----|-------------|
| 1 | Memory | ✅ | Read/write workspace files | 2026-02-14 |
| 2 | Files | ✅ | read/write/edit tools | 2026-02-14 |
| 3 | Terminal | ✅ | exec tool | 2026-02-14 |
| 4 | Web Search | ✅ | Brave API (config: tools.web.search) | 2026-02-14 |
| 5 | Gmail | ✅ | gog CLI (~/go/bin/gog gmail) | 2026-02-14 |
| 6 | Calendar | ✅ | gog CLI (~/go/bin/gog calendar) | 2026-02-14 |
| 7 | Cron/Reminders | ✅ | cron tool (7 jobs active) | 2026-02-14 |
| 8 | Chat (WA/TG/Slack) | ✅ | Channel plugins | 2026-02-12 |
| 9 | Images (DALL-E) | ✅ | OpenAI API (config: skills.entries.openai-image-gen) | 2026-02-14 |
| 10 | Voice Transcription | ✅ | OpenAI Whisper API (same key as #9) | 2026-02-14 |
