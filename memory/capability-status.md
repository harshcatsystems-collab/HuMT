...
# Last full audit: 2026-02-17 00:00 UTC (auto-cron)
...
## Last Verified: 2026-02-17 00:00 UTC
## Environment: VPS (Debian 12, GCP, 34.93.212.225)

| # | Capability | Status | How | Last Tested |
|---|-----------|--------|-----|-------------|
| 1 | Memory | ✅ | Read/write workspace files | 2026-02-17 |
| 2 | Files | ✅ | read/write/edit tools | 2026-02-17 |
| 3 | Terminal | ✅ | exec tool | 2026-02-17 |
| 4 | Web Search | ✅ | Brave API (config: tools.web.search) | 2026-02-17 |
| 5 | Gmail | ✅ | gog CLI (~/go/bin/gog gmail) | 2026-02-17 |
| 6 | Calendar | ✅ | gog CLI (~/go/bin/gog calendar) | 2026-02-17 |
| 7 | Cron/Reminders | ✅ | cron tool (9 jobs active) | 2026-02-17 |
| 8 | Chat (WA/TG/Slack) | ✅ | Channel plugins | 2026-02-12 |
| 9 | Images (DALL-E) | ✅ | OpenAI API (config: skills.entries.openai-image-gen) | 2026-02-17 |
| 10 | Voice Transcription | ✅ | OpenAI Whisper API (same key as #9) | 2026-02-17 |
